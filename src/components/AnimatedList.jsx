      ...
      <div
        ...
        {items.map((item, index) => (
          <AnimatedItem
            ...
            <div
              className={`bg-transparent ${selectedIndex === index ? 'bg-white/[0.05]' : 'hover:bg-white/[0.02]'} transition-colors ${itemClassName}`}>
              <div className="text-white m-0 w-full">{item}</div>
            </div>
          </AnimatedItem>
        ))}
      </div>
