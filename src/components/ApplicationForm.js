        ...
        {step === 1 && (
          <form onSubmit={handleNext} className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full bg-[#9b1a1a] hover:bg-[#cc0000] text-white font-bold uppercase tracking-widest text-sm py-4 rounded-lg flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(155,26,26,0.2)] hover:shadow-[0_0_30px_rgba(155,26,26,0.4)] disabled:opacity-50"
            >
          ...
          <form onSubmit={handleNext} className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex gap-4 mt-4">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="flex-1 bg-transparent border border-white/10 hover:border-white/20 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-lg transition-all"
              >
                Back
              </button>
              <button
                type="submit"
                className="flex-[2] bg-[#9b1a1a] hover:bg-[#cc0000] text-white font-bold uppercase tracking-widest text-sm py-4 rounded-lg flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(155,26,26,0.2)]"
              >
