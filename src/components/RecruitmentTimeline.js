            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-full pl-20 pr-6 md:w-1/2 ${isLeft ? "md:pr-24 md:pl-0 text-left md:text-right" : "md:pl-24 md:pr-0 text-left"}`}
                  >
                    <div
                      className={`flex flex-col ${isLeft ? "items-start md:items-end" : "items-start"}`}
                    >
