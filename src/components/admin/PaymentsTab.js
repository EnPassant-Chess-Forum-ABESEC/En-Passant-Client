            ...
            {payments.length === 0 ? (
              ...
              payments.map((payment) => (
                ...
                >
                  ...
                  <td className="px-4 py-5">
                    {payment.applicationId ? (
                      <button
                        ...
                        className="font-mono text-xs text-slate-600 tracking-wider hover:text-slate-800 transition-colors flex items-center gap-2"
                      ...
                      >
                        ...
                        {copiedId === payment.applicationId && (
                          <span className="text-[10px] text-green-400 font-sans tracking-widest uppercase">
                            Copied!
                          </span>
                        )}
                      </button>
                  ...
                  <td className="px-6 py-5 font-mono font-bold tracking-wide text-slate-800">
                    ₹{payment.amount / 100}
                  </td>
                    ...
                    {payment.paymentScreenshotUrl ? (
                      <div className="flex flex-col gap-1">
                        <a
                          ...
                          className="flex items-center gap-1 text-blue-600 hover:text-[#ff3333] transition-colors text-xs font-bold uppercase tracking-widest"
                        >
                  ...
                  <td className="px-6 py-5 text-sm text-slate-500 tracking-wide">
