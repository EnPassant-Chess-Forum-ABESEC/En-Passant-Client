  ...
  return (
    <main className="w-full bg-[#0a0a0a] font-sans">
      ...
      <div className="absolute inset-0 z-10 w-full h-full">
        <Image
          src="/recruitment_hero_image.png"
          alt="Recruitment Hero"
          fill
          priority
          className="object-cover object-center opacity-90"
        />
        {/* Soft bottom fade to blend the image base */}
      ...
      {/* Call to Action */}
      <div className="absolute bottom-12 left-0 w-full px-6 md:px-12 z-40 flex justify-center pointer-events-none">
      ...
      <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[#0a0a0a] to-transparent z-30 pointer-events-none"></div>
      </section>
